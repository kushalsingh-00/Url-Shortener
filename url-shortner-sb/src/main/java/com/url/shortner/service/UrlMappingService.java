...
import com.url.shortner.respository.ClickEventRepository;
import com.url.shortner.respository.UrlMappingRepository;
...
public class UrlMappingService {
    ...
    public Map<LocalDate, Long> getTotalClicksByUser(User user, LocalDate start, LocalDate end) {
        ...
        List<ClickEvent> clickEventList = clickEventRepository.findByUrlMappingInAndClickDateBetween(urlMappingList,start.atStartOfDay(),end.plusDays(1).atStartOfDay());
